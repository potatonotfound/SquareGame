...
kill_6 = c.create_rectangle(320, 280, 320, 360, fill="red")
kill_7 = c.create_rectangle(80, 280, 120, 320, fill="red")
kill_8 = c.create_rectangle(0, 120, 40, 160, fill="red")
kill_9 = c.create_rectangle(0, 320, 40, 360, fill="red")
...
win_6= c.create_rectangle(120, 80, 160, 120, fill="gray")
win_7= c.create_rectangle(360, 360, 360, 400, fill="gray")
win_8= c.create_rectangle(80, 40, 120, 80, fill="gray")
win_9= c.create_rectangle(360, 40, 400, 80, fill="gray")
win_10= c.create_rectangle(80, 320, 120, 360, fill="gray")
...
def win_boxes_touched():
    ...
    box6_pos = c.coords(win_6)
    box7_pos = c.coords(win_7)
    box8_pos = c.coords(win_8)
    box9_pos = c.coords(win_9)
    box10_pos = c.coords(win_10)
    if player_pos[0] == box1_pos[0] and player_pos[1] == box1_pos[1] and player_pos[2] == box1_pos[2] and player_pos[3] == box1_pos[3]:
        ...
        win_boxes[4] = True
        root.update()
    elif player_pos[0] == box6_pos[0] and player_pos[1] == box6_pos[1] and player_pos[2] == box6_pos[2] and player_pos[3] == box6_pos[3]:
        c.itemconfigure(win_6, fill="green")
        win_boxes[5] = True
        root.update()
    elif player_pos[0] == box7_pos[0] and player_pos[1] == box7_pos[1] and player_pos[2] == box7_pos[2] and player_pos[3] == box7_pos[3]:
        c.itemconfigure(win_7, fill="green")
        win_boxes[6] = True
        root.update()
    elif player_pos[0] == box8_pos[0] and player_pos[1] == box8_pos[1] and player_pos[2] == box8_pos[2] and player_pos[3] == box8_pos[3]:
        c.itemconfigure(win_8, fill="green")
        win_boxes[7] = True
        root.update()
    elif player_pos[0] == box9_pos[0] and player_pos[1] == box9_pos[1] and player_pos[2] == box9_pos[2] and player_pos[3] == box9_pos[3]:
        c.itemconfigure(win_9, fill="green")
        win_boxes[8] = True
        root.update()
    elif player_pos[0] == box10_pos[0] and player_pos[1] == box10_pos[1] and player_pos[2] == box10_pos[2] and player_pos[3] == box10_pos[3]:
        c.itemconfigure(win_10, fill="green")
        win_boxes[9] = True
        root.update()
...
def if_dead():
    ...
    kill6_pos = c.coords(kill_6)
    kill7_pos = c.coords(kill_7)
    kill8_pos = c.coords(kill_8)
    kill9_pos = c.coords(kill_9)
    ...
    if player_pos[0] == kill5_pos[0] and player_pos[1] == kill5_pos[1] and player_pos[2] == kill5_pos[2] and player_pos[3] == kill5_pos[3] and not dead and not win:
        dead = True
        game_over()
    if player_pos[0] == kill6_pos[0] and player_pos[1] == kill6_pos[1] and player_pos[2] == kill6_pos[2] and player_pos[3] == kill6_pos[3] and not dead and not win:
        dead = True
        game_over()
    if player_pos[0] == kill7_pos[0] and player_pos[1] == kill7_pos[1] and player_pos[2] == kill7_pos[2] and player_pos[3] == kill7_pos[3] and not dead and not win:
        dead = True
        game_over()
    if player_pos[0] == kill8_pos[0] and player_pos[1] == kill8_pos[1] and player_pos[2] == kill8_pos[2] and player_pos[3] == kill8_pos[3] and not dead and not win:
        dead = True
        game_over()
    if player_pos[0] == kill9_pos[0] and player_pos[1] == kill9_pos[1] and player_pos[2] == kill9_pos[2] and player_pos[3] == kill9_pos[3] and not dead and not win:
        dead = True
        game_over()
