...
kill = c.create_rectangle(280, 280, 320, 320, fill="red")
...
level = c.create_text(200, 440, text="Level 1", font=("Arial", 50))
...
def if_dead():
    global dead
    player_pos = c.coords(player)
    kill_pos = c.coords(kill)
    if player_pos[0] == kill_pos[0] and player_pos[1] == kill_pos[1] and player_pos[2] == kill_pos[2] and player_pos[3] == kill_pos[3] and not dead and not win:
        dead = True
        game_over()
